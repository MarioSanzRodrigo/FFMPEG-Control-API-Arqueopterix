...
#if test -z "$*"; then
#        echo "I am going to run ./configure with --enable-maintainer-mode" //RAL: commented
...
echo "  autoconf"
autoconf || exit 1
#echo "  configure --enable-maintainer-mode $@" //RAL: commented
#$srcdir/configure --enable-maintainer-mode "$@" || exit 1 //RAL: commented
